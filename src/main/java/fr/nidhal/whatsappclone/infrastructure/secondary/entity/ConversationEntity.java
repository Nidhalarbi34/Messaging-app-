package fr.nidhal.whatsappclone.infrastructure.secondary.entity;

import fr.nidhal.whatsappclone.messaging.domain.message.aggregate.Conversation;
import fr.codecake.whatsappclone.messaging.domain.message.aggregate.ConversationBuilder;
import fr.nidhal.whatsappclone.messaging.domain.message.aggregate.ConversationToCreate;
import fr.nidhal.whatsappclone.messaging.domain.message.vo.ConversationName;
import fr.nidhal.whatsappclone.messaging.domain.message.vo.ConversationPublicId;
import fr.nidhal.whatsappclone.shared.jpa.AbstractAuditingEntity;
